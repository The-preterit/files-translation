...
def main():
    ...
    parser.add_argument("--env-file", type=str, default=".env", help="Path to the .env file (default: .env)")
    ...
    # Load .env file as early as possible so all subsequent code sees the variables
    env_path = Path(args.env_file)
    if env_path.exists():
        load_dotenv(dotenv_path=env_path)
    else:
        # Also try loading from the current working directory as a fallback
        load_dotenv()
